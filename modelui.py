    ...
    while True:
        try:
            ...
            if not data_queue.empty():
                ...
                # Display transcription live on Streamlit
                transcription_text.text(f"Transcription: {text}")
                ...
                # Display translation live on Streamlit
                translation_text.text(f"{tgt_lang}: {translations[0]}")
